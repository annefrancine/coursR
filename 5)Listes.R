# À la differences des vecteurs, les listes peuvent contenir des objets 
#de natures differentes. Une liste peut combiner des vecteurs, 
...
#assignation par indexation fonctionne egalement avec les doubles crochets 
# ou le signe dollar

l <- list(l1, l2)
l
l[[2]] <- list(c("un", "vecteur", "textuel"))#nommer liste
l$mois <- c("Janvier", "Fevrier", "Mars")
l
