...
#If : executer une action si la condition est vérifiee
...
#Il est possible de declencher une action si la condition n'est pas verifiee grâce à l'élément else. 
# L'element else doit être situe sur la meme ligne que le crochet fermant la condition.
...
ifelse(x < 5, "inferieur a 5", 
       ifelse(x == 5, "egal à 5", "superieur a 5"))
