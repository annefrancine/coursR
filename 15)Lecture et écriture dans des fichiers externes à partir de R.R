#Remarques:
#getwd : affiche le chemin dâacces au repertoire de travail,
#setwd : permet de changer de repertoire de travail.
#pas de \ : seuls / et \\ sont acceptes pour separer les elements dâun chemin dâacces;
#toujours inclure l'extension du fichier;
#encadrer le chemin de guillemets.

#Etape 1:definir le repertoire de travail

#Etape2: Acceder au systeme de fichiers de notre ordinateur Ã  partir de R

#Ainsi, R a acces au systeme de fichiers ordinateur 
#Ã  partir duquel la session a ete demarree. Par defaut, 
#lâacces se fait Ã  partir du repertoire de travail. 
...
#l'importation de donnees. Les donnees � importer en R 
...
#texte (dont CSV), JSON, EXCEL, formats propres � un logiciel statistique 

# Importation de donnees � partir d'un fichier texte
...
#Largument na.strings de read.table indique � R
...
#spÃ©cifier le type de donnÃ©es dans chacune des colonnes.
...
#Importation de donnees à partir d'un fichier EXCEL
